...
1. Search for "WP 3D Slice Box Slider"
1. Click 'Install'
...
1. Upload the `wpsliceboxslider` folder to the `/wp-content/plugins/` directory
1. Activate the `wpsliceboxslider` plugin through the 'Plugins' menu in WordPress
